...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Here is the breakdown of your earnings this week: " + "\n\tYour regular hours pay adds up to $" + rH);
		System.out.println("\tYour pay coming from special hours is $" + sH);
		System.out.println("\tYour pay for the overtime hours is $" + oT);
		System.out.println("You worked a total of " + totalHours
				+ " hours this week. Your total remuneration then adds up to $" + total);
